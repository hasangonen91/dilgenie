...
- [x] **A1ListeningData: school kategorisi** — `vocabulary/A1ListeningData.json` dosyasına `school` anahtarı ekle (aynı format). `questions` dizisinde TAM 5 soru, konu: okul (book, pen, teacher, classroom, homework vb.).
