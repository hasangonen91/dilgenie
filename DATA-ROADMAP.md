...
- [ ] **A1ListeningData: clothes kategorisi** — `food_drinks` anahtarından SONRA `clothes` anahtarı ekle (aynı format). `questions` dizisinde TAM 5 soru, konu: kıyafetler (shirt, hat, shoes, dress, coat vb.). Sıra bozma, diğer kategorilere dokunma.
